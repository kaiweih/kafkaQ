    ...
    return (
      <div className="box">
        <Card.Group className="cardGroup">
          <Card className="card">
            <Image src={jonathan} wrapped ui={false} />
            <Card.Content>
              <Card.Header>Jonathan Barenboim</Card.Header>
              <Card.Description
                style={{ marginTop: '0.5rem', marginBottom: '1rem' }}
              >
                Fullstack software engineer at kafkaQ
              </Card.Description>
            </Card.Content>
            <Card.Content extra>
              <a
          ...
          <Card className="card">
            <Image src={kaiwei} wrapped ui={false} />
            <Card.Content>
          ...
          <Card className="card">
            <Image src={micah} wrapped ui={false} />
            <Card.Content>
          ...
          <Card className="card">
            <Image src={shreshth} wrapped ui={false} />
            <Card.Content>
            ...
            <Card.Content extra>
              <a href="https://www.linkedin.com/in/shreshth-srivastava" target="_blank">
                <img
                  className="cardicon"
                  src={linkedinIcon}
                  width="35"
